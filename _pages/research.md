...
< ![]({{ site.url }}{{ site.baseurl }}/images/respic/summaryA2.jpg){: style="width: 50%; border-radius: 10px; display: block; margin-left: auto; margin-right: auto; box-shadow: 0 0 14px 2px rgba(196,196,196,1); float: left"} >
...
< ![]({{ site.url }}{{ site.baseurl }}/images/respic/summaryB.jpg){: style="width: 25%; border-radius: 10px; display: block; margin-left: auto; margin-right: auto; box-shadow: 0 0 14px 2px rgba(196,196,196,1); float: right"} >
