...
![]({{ site.url }}{{ site.baseurl }}/images/respic/summary.jpg){: style="width: 80%; border-radius: 10px; display: block; margin-left: auto; margin-right: auto; box-shadow: 0 0 14px 2px rgba(196,196,196,1);"}
